...
tess_barplot(qmat2, col_pal = pal)
tess_barplot(qmat3, col_pal = pal)
tess_barplot(qmat4, col_pal = pal)
tess_barplot(qmat5, col_pal = pal)
tess_barplot(qmat6, col_pal = pal)
```
...
tess_ggplot(krig_admix, plot_method = "maxQ", ggplot_fill = scale_fill_manual(values = pal()))
```
