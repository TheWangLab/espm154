...
vos_vcf <- read.vcfR("data/vos_maf05.eff.vcf")
...
van_vcf <- read.vcfR("data/bif_maf05.eff.vcf")
van_coords <- 
  read.csv("data/bif_coords.csv") %>%
  st_as_sf(coords = c("lon", "lat"), crs = 4326)
```
...
7. Use the Genome Browser to explore candidate loci (use the UCSC Genome Browser link provided above)
